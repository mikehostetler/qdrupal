...
//		protected function Form_PreRender() {}
		...
		protected function Form_Create() {
			...
			$this->mct<%= $objTable->ClassName %> = <%= $objTable->ClassName %>MetaControl::CreateFromQueryString($this);
...
<% } %>
		...
		protected function RedirectToListPage() {
			...
			$strListPageUrl = $f . '/' . $strListPageUrl;
			QApplication::Redirect($strListPageUrl);
		}
	}
	...
	<%= $objTable->ClassName %>EditForm::Run('<%= $objTable->ClassName %>EditForm',qdrupal_tmpl_path(__FILE__));
?>